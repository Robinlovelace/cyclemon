...
To define the 'area of interest' associated with each parish, we used a 2 stage buffering process:
...
The process is illustrated in Figure \@ref(fig:buffers).

```{r buffers, eval=TRUE, fig.cap="Illustration of the three stage buffering process to identify areas of interest within which travel to destinations in the zones could take place"}
